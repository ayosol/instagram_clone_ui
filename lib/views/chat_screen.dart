...
import 'package:instagram_clone_ui/views/chat_detail_screen.dart';
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 14, height: 1.5, color: black.withOpacity(0.8)),
            ),
            SizedBox(height: 20),
            Container(
              height: 50,
              ...
              child: Center(
                child: Text("Create Room", style: TextStyle(color: white)),
              ),
            ),
          ],
        ),
    ...
    if (selectedIndex == 0) {
      return Container(
        ...
        decoration: BoxDecoration(
            color: grey,
            border: Border(
                top: BorderSide(width: 1, color: grey.withOpacity(0.3)))),
        child: Row(
