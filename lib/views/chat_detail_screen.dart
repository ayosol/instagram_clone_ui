...
import 'package:instagram_clone_ui/util/chat_details_json.dart';
import 'package:instagram_clone_ui/util/chat_json.dart';
...
class _ChatDetailPageState extends State<ChatDetailScreen> {
  @override
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: Icon(Feather.camera, color: white),
                          ),
                        ),
                        Container(
...
class ChatBubbles extends StatelessWidget {
  ...
  const ChatBubbles(
      {Key key, this.isMe, this.profile, this.message, this.messageNo})
      : super(key: key);
